    ...
    <header className="sticky top-0 z-20 bg-card border-b border-border h-16 flex items-center px-4 lg:px-6 gap-4 shadow-sm">
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center gap-2 lg:hidden">
          <div className="w-7 h-7 bg-primary rounded-lg flex items-center justify-center" style={{boxShadow:'0 0 14px 3px rgba(225,29,42,0.5)'}}><span className="text-white font-bold text-xs">eK</span></div>
          <span className="font-bold text-primary text-base" style={{textShadow:'0 0 10px rgba(225,29,42,0.35)'}}>e-Khadi</span>
        </div>
      </div>
